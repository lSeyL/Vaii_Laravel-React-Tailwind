  ...
  const faqData = [
    {
      ...
      answer:
        "Yes. All our assets are released under the CC0 license, meaning you can use them for absolutely any purpose, including commercial work.",
    },
    {
      question: "Can I request a custom 3D product?",
      answer:
        "Absolutely! We specialize in creating custom 3D products tailored to your needs. Reach out to us with your requirements, and we'll make it happen.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes. The only thing you can't do is claim to be the original author or re-license them..",
    },
    {
      question: "Do you do commissions?",
      answer:
        "Poly Haven does not itself do commissions, but our artists may be happy to work with you. Please get in touch and we can point you in the right direction.Often we offer discounts if you allow us to publish your assets on Poly Haven too.",
    },
  ];
